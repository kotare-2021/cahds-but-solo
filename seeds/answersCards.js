  ...
  return knex('answersCards').del()
    .then(function () {
      ...
      return knex('answersCards').insert([
        ...
        {id: 7, answer: 'Your weird brother',round_id: 500, player_id: 0 },
        ...
        {id: 11, answer: 'Knife crime',round_id: 500, player_id: 0 },
        {id: 12, answer: 'The economy',round_id: 500, player_id: 0 },
        {id: 13, answer: 'Being a dinosaur',round_id: 500, player_id: 0 },
        {id: 14, answer: 'Positive feedback',round_id: 500, player_id: 0 },
